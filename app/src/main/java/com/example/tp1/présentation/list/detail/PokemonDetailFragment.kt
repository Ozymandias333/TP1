package com.example.tp1.présentation.list.detail
...
import com.example.tp1.présentation.list.API.PokemonDetailResponse
...
class PokemonDetailFragment : Fragment() {
    ...
    private fun callApi() {
        Singletons.pokemonAPI.getPokemonDetail("1")?.enqueue(object : Callback<PokemonDetailResponse> {
